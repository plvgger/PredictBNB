    ...
    <div className="min-h-screen gradient-bg">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900">Your Portfolio</h2>
          <p className="text-gray-600 mt-2">Track your positions and PnL</p>
        </div>

        <div className="card p-12 text-center">
          <p className="text-gray-600">Portfolio tracking coming soon. Start trading to build your portfolio.</p>
